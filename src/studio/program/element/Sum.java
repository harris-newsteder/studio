...
public class Sum extends Block {
    ...
    public void createPins(Program program) {
        Pin in1 = new Pin(this, Pin.SignalType.NUMBER, Pin.Flow.INPUT);
        in1.setSide(Pin.Side.LEFT);
        in1.setAttachmentPoint(-width / 2, -20);
        in1.updatePosition();

        Pin in2 = new Pin(this, Pin.SignalType.NUMBER, Pin.Flow.INPUT);
        in2.setSide(Pin.Side.LEFT);
        in2.setAttachmentPoint(-width / 2, 20);
        in2.updatePosition();

        Pin out1 = new Pin(this, Pin.SignalType.NUMBER, Pin.Flow.OUTPUT);
